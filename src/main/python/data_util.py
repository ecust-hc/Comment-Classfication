...
# how_to_use
how_to_use_reference = os.path.join(DATA_DIR, "how-to-use(code2seq)", "ref.txt")
how_to_use_hypothesis = os.path.join(DATA_DIR, "how-to-use(code2seq)", "pred.txt")
how_to_use_code = os.path.join(DATA_DIR, "how-to-use(code2seq)", "code.txt")
# how_it_is_done
how_it_is_done_reference = os.path.join(DATA_DIR, "how-it-is-done(nngen)", "test.token.nl")
how_it_is_done_hypothesis = os.path.join(DATA_DIR, "how-it-is-done(nngen)", "how-it-is-done.nl")
how_it_is_done_code = os.path.join(DATA_DIR, "how-it-is-done(nngen)", "how-it-is-done.code")
# property
